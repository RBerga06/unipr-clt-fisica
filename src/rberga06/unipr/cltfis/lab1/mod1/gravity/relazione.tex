...
\emph{
    ...
    media della sferetta nell'intervallo di tempo $t_i$.
}

Per determinare $g$ e $v_0$, possiamo semplicemente effettuare una regressione
lineare (pesata\footnote{
    \emph{Vedi} \emph{Osservazione} successiva.
}) con equazione (\ref{eq:2}).

Qui riportiamo gli istogrammi dei tempi misurati, seguiti da una tabella
riassuntiva e dal grafico della regressione lineare, assieme ai relativi risultati:
