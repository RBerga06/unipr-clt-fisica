...
\begin{enumerate}
    ...
    \item Per ogni campione, ne calcoliamo il volume $V$ (e la sua incertezza):
    \begin{itemize}
    ...
    \item Per valutare numericamente la consistenza dei risultati ottenuti con i valori indicati in letteratura,
