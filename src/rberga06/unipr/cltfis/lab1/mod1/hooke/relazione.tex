...
Per determinare anche in questo caso la costante elastica della molla,
abbiamo effettuato una regressione lineare sui quadrati dei valori medi
delle distribuzioni di cui sopra rispetto alla massa, facendo riferimento
alla formula $T^2 = \frac{4\pi^2}{k} m$. Allora, detto $b$ il
...
compatibile con $0$. Ecco la retta di regressione e i relativi risultati:
...
Nel nostro caso, $\varepsilon = 1.33$.
