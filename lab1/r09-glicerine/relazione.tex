...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item
      Misuriamo la massa media\footnote{
      ...
      } $\overline{m}_k$ e il diametro medio\footnote{
        ...
        per il diametro medio di tutte le sferette, anche considerato
        il fatto che i tre valori, in tutte le misurazioni, erano
        compatibili fra loro.
      } $\overline{d}_k$ di tutte e $N_k$ le sferette.
...
Possiamo allora studiare il moto del corpo.
Per semplificare la trattazione, assumeremo:
\begin{enumerate}
  \item Che la traiettoria sia rettilinea, parallela a $\vec{g}$:
    allora, poiché $\vec{r}\parallel\hat{z}$, indicheremo
    direttamente con $z_i(t)\hat{z}$ la posizione del centro di massa
    della sferetta\footnote{
      Da qui in avanti, utilizzeremo la notazione di Newton per indicare
      tutte le derivate rispetto al tempo: in particolare, velocità e
      accelerazione istantanee del centro di massa della sferetta
      saranno allora $\dot{z}_i(t)\hat{z}$ e $\ddot{z}_i(t)\hat{z}$.
    } rispetto all'origine del sistema di riferimento.
  \item Che il moto avvenga in regime laminare
    (ovvero $\text{Re}=\frac{\rho\diam}{\eta}|\dot{z}| \ll 1200$,
     dove $\diam$ è il diametro del recipiente e $\rho$ la densità
     della soluzione).
  ...
  \item Che $d_z$ non superi, in ordine di grandezza,
    $10^{-3}\,\unit{m}$.
\end{enumerate}
...
Le uniche forze applicate alla sferetta sono la forza peso
$\frac{4}{3}\pi g\overline{r}_k^2 \overline{\rho}_k \hat{z}$,
la forza di Archimede
$-\frac{4}{3}\pi g\overline{r}_k^2 \rho_\text{sol} \hat{z}$
e la forza d'attrito viscoso del fluido $\vec{F}_\eta$.
Quest'ultima, sotto le ipotesi (2.), (3.) e (4.) sopra esposte,
è della forma:
\[\vec{F}_\eta = -6\pi\eta \overline{r}_k \dot{z}\hat{z}\]
