...
\begin{center}
  \begin{tblr}{
    ...
    \hline
    Telecamera & $\qty{0.001}{s}$ & N./A. & $\qty{0.001}{s}$ \\  %TODO:verificare i valori
    \hline[dashed]
  ...
  \begin{tblr}{
    ...
    {Sferette \\ (con masse e raggi distinti)} & { %TODO:trovare un nome alternativo per le sferette
      Raggruppabili in tre diversi insiemi,
      ognuno dei quali ha palline di un certo
      raggio e di una certa massa.
      } \\
    \hline
  \end{tblr}
\end{center}
...
Ripetiamo 3 volte, ovvero per ogni gruppo di sferette, i seguenti passi:
\begin{enumerate}
  \item
    Misuriamo la massa di tre sferette con la bilancia di precisione,
    e da questi tre valori troviamo una massa media per il gruppo,
    non essendo le palline esattamente identiche.
  \item
    Per lo stesso motivo, misuriamo i diametri di tre sferette con il
    micrometro ad asta filettata, ricavandone uno medio per il gruppo.
    (Questi primi due processi servono per conoscere la densità delle palline)
  \item
    RIasciamo le sferette una ad una nel becher contenente la glicerina,
    realizzando un video della loro discesa.
  \item
    Avvalendoci dell'apposito programma, analizziamo la posizione delle
    sferette in funzione del tempo durante la loro caduta.
