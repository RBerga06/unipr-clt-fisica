...
in relazione i valori medi per ogni classe: \[
  ...
  \qquad\qquad
  \text{Re}_k = \frac{
    \rho_\text{sol}\cdot\diam\cdot\overline{v}_i}{\eta_\text{sol}}
\]
...
\textbf{Osservazione}. Ricordiamo il numero di Reynolds:
\[
  \text{Re} = \frac{\rho_\text{sol}\cdot\diam\cdot \overline{v}_k}{\eta_\text{sol}}
\]
...
abbiamo calcolato i seguenti valore (numeri puri):
\[
