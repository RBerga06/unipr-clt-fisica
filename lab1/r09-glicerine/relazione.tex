...
\begin{enumerate}
  \item Che la traiettoria sia rettilinea, parallela a $\vec{g}$:
    ...
    direttamente con $z_i(t)$ la posizione del centro di massa
    della sferetta\footnote{
      ...
      saranno allora $\dot{z}_i(t)$ e $\ddot{z}_i(t)$.
...
Le uniche forze applicate alla sferetta sono le seguenti:
\begin{itemize}
  \item Forza peso: $\vec{F_p}=m_i \vec{g}$
\end{itemize}
