...
\emph{
  \textbf{Nota.} La struttura di tutti e quattro i grafici è la seguente:
  \begin{itemize}
...
mediante l'apparato sperimentale abbiamo determinato misure
dei calori specifici dei campioni compatibili con quelle attese.
