...
Questa ipotesi è sostenuta dal fatto che $\lambda_\text{vap,aperto}$,
pur risultando anch'esso non compatibile, si avvicina di più al valore
atteso $\lambda_\text{vap,atteso}$.
...
aggira attorno ai $\qty{308}{g}$, quando il calorimetro ne
conteneva ben di più.
