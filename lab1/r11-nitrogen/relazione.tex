...
\begin{enumerate}
  ...
  \item
    ...
    del filmato.
  \item
    Ripetiamo lo stesso procedimento, ma inserendo un tappo non ermetico
    nel foro centrale del tappo del calorimetro, in modo da evitare la
    fuoriuscita di azoto gassoso.
\end{enumerate}

\subsection{Analisi dei dati raccolti e conclusioni} %TODO: cambiare i pedici
  Prima di tutto, definiamo il calore assorbito dall'azoto liquido come
  il prodotto tra il calore latente di vaporizzazione e la variazione di massa:
  $Q = \lambda_{vap} \Delta m$.

  Essendo note (oltre all'intervallo di tempo) tensione ed intensità della corrente,
  possiamo esprimere il calore fornito anche come: $Q = I \Delta V \Delta t$.

  Eguagliando queste ultime due relazioni, ricaviamo che il calore latente dell'azoto liquido sarà:
  $\lambda_{vap} = \frac{I \Delta V \Delta t}{\Delta m}$.

  Ponendo $\gamma = \frac{\Delta m}{\Delta t}$, possiamo riscrivere la precedente espressione come:
  $\lambda_{vap} = \frac{I \Delta V}{|\gamma|}$.
...
\begin{enumerate}
  \item
    Posto il calorimetro sopra alla bilancia di precisione, avviamo la cattura del filmato.
  \item
    Dopo circa una decina di secondi (non è rilevante per la riuscita dell'esperienza),
    accendiamo il generatore in modo da fornire calore all'azoto per mezzo della resistenza.
  \item
    Passato un tempo sufficiente, spegniamo la resistenza e %TODO: scrivere quanto bisogna aspettare
    dopo un'altra decina di secondi terminiamo la registrazione video.
  \item
    Ripetiamo lo stesso procedimento, ma insererndo un tappo non ermetico
    nel foro centrale del tappo del calorimetro, in modo da evitare la
    fuoriuscita di azoto gassoso.
\end{enumerate}
