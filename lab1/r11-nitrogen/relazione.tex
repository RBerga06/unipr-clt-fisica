...
\begin{figure}[H]
  ...
  ]{\includegraphics[trim={2cm 0.6cm 3cm 1cm},clip,width=.49\textwidth]{img/g_piombo.png}}\hfil
  \subfloat[][
    Campione $\Delta$

    $\Delta V=(0.032\pm0.007)\,\unit{mV}$
  ]{\includegraphics[trim={2cm 0.6cm 3cm 1cm},clip,width=.49\textwidth]{img/g_ottone.png}}\hfil
  \subfloat[][
    Campione $\aleph$

    $\Delta V=(0.032\pm0.007)\,\unit{mV}$
  ]{\includegraphics[trim={2cm 0.6cm 3cm 1cm},clip,width=.49\textwidth]{img/g_alluminio.png}}\hfil
  \subfloat[][
    Campione $\nabla$

    $\Delta V=(0.032\pm0.007)\,\unit{mV}$
  ]{\includegraphics[trim={2cm 0.6cm 3cm 1cm},clip,width=.49\textwidth]{img/g_rame.png}}\hfil
\end{figure}
