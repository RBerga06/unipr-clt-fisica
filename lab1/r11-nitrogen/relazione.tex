...
\vspace{2mm}
Di seguito riportiamo, in grafico, i dati acquisiti.
...
\begin{figure}[H]
  ...
  ]{\includegraphics[trim={2.5cm 0.6cm 3cm 1cm},clip,width=.49\textwidth]{img/g_azoto2.png}}\hfil
  \subfloat[][
    Foro aperto

    $\Delta V=(0.032\pm0.007)\,\unit{mV}$
  ]{\includegraphics[trim={2.5cm 0.6cm 3cm 1cm},clip,width=.49\textwidth]{img/g_azoto3.png}}\hfil
  \caption[]{\emph{
