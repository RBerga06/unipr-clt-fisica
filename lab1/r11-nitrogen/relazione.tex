...
\begin{abstract}
  Il gruppo di lavoro ha misurato i calori specifici ($c_x$) di alcuni
  materiali mediante un calorimetro ad azoto liquido.
\end{abstract}
...
\begin{center}
  \begin{tblr}{
    ...
    \hline
    Amperometro & $\qty{0.002}{rad}$ & N./A. & $\qty{0.002}{rad}$ \\
    \hline[dashed]
    Voltmetro & $\qty{0.002}{rad}$ & N./A. & $\qty{0.002}{rad}$ \\
    \hline[dashed]
  ...
  \begin{tblr}{
    ...
    Calorimetro & {
      ...
      Il rotore è invece innestato nel sensore di rotazione.
    } \\
    \hline[dashed]
