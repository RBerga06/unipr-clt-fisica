...
\begin{enumerate}
  \item
    Posto il calorimetro sopra alla bilancia, avviamo la registrazione video.
  \item
    ...
    Tensione ed intensità della corrente sono note grazie a voltmetro ed amperometro.
  \item
    Aspettato ... interrompiamo il flusso di calore
    e dopo un'altra decina di secondi terminiamo il filmato.
\end{enumerate}
