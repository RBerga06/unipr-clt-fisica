...
\begin{center}
    \begin{tblr}{ |Q[l,m]|Q[c,m]|Q[c,m]|Q[c,m]| }
        ...
        \hline[dashed]
        Tre campioni metallici & \SetCell[c=3]{l} {Li chiameremo $A$, $B$ e $C$.} \\
        \hline
    \end{tblr}
\end{center}
...
È pertanto possibile determinare $\tau$ mediante una regressione lineare (pesata\footnote{
    ...
    gli errori assoluti sull'ordinata variano notevolmente. Per leggibilità,
    ...
    degli errori, come indicato alla nota 2.
}):
