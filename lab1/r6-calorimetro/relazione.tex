...
\begin{center}
    \begin{tblr}{ |Q[l,m]|Q[c,m]|Q[c,m]|Q[c,m]| }
        ...
        \hline[dashed]
        Barometro & $\qty{00}{hPa}$ & $\qty{00}{hPa}$ & $\qty{00}{hPa}$ \\
        \hline[dashed]
        Bilancia & $\qty{0.5}{g}$ & $\qty{4100.00}{g}$ & $\qty{0.01}{g}$ \\
        \hline
        \hline
        \textbf{Altro} & \SetCell[c=3]{l} \textbf{Descrizione/Note} \\
        \hline
        Calorimetro & \SetCell[c=3]{l} {
            sistema isolato termicamente e pressoché adiabatico.
        } \\
        \hline[dashed]
        {Fornelletto e pentolino} & \SetCell[c=3]{l} {
            Per scaldare l'acqua e quindi anche i campioni.
        } \\
        \hline[dashed]
