...
%QUA SERVIREBBE UN "A CAPO", CHE NON SO INSERIRE
...
seguente grafico, abbiamo trovato che $T_\text{eq} = \qty{46,35}{\degree C}?$. Dunque:    %TODO: mettiamo il grafico?
    \[
...
\begin{center}
    \begin{tabular}{ |c|c|c| }
        ...
        %$T_\text{eq}$ ($\unit{\degree C}$)
        \hline
        $A$ & 12.43 ± 0.01 & 25.2 ± 0.2 & 0 ± 0 \\
        $B$ & 28.73 ± 0.01 & 25.9 ± 0.2 & 0 ± 0 \\    %TODO: calcolare i valori
