...
\]
D'ora in avanti indicheremo con $\clubsuit$ la costante $\frac{r^2\ln{2}}{4T_\frac{1}{2}}$.
La relazione diventa allora:
\[\overline{x_i} = N\clubsuit d_i^{-2} + \overline{x_0}\]
...
\[\overline{x_i} = \frac{mr^2\ln{2}}{4 T_\frac{1}{2} (90(m_p + m_e) + 142m_n)} d_i^{-2}
                   + \overline{x_0}\]
