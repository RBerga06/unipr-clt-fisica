...
$\Th$ e alla massa $m$ di $\Th$ secondo la seguente relazione\footnote{
    Se la massa del campione è $m$, il numero di atomi è:
    \[
        N = \frac{m}{m_\text{atomo}} =
        \frac{m}{90(m_p+m_e) + (232-90)m_n}
    \]
    Il numero medio $\overline{X}$ di raggi $\gamma$ emessi dal campione sarà allora:
    \[
    ...
    \[
        ...
        \frac{r^2N\ln{2}}{4 d_i^2 T_\frac{1}{2}}
    \]
    ...
    contributi introducendo un termine costante $x_0$, che chiameremo “conteggi
    relativi alla radioattività ambientale”:
    \[
        \overline{x_i} = \frac{r^2N\ln{2}}{4 d_i^2 T_\frac{1}{2}} + x_0
    \]
    Sostituendo l'espressione di $N$, si ottiene la formula riportata.
}:
\[
    \overline{x_i} = \frac{mr^2\ln{2}}{4 d_i^2 T_\frac{1}{2} (90(m_p + m_e) + 142m_n)}
\]
