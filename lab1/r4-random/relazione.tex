...
(con $i\in\left[1;5\right]\cap\mathbb{N}$), il gruppo di lavoro ha acquisito
i conteggi di raggi $\gamma$ emessi nella direzione del contatore ogni secondo
($\gamma_{ti}$) per un tempo complessivo di circa un'ora
($t\in\left[1;3657\right]\cap\mathbb{N}$)\footnote{
    Abbiamo scelto di acquisire esattamente 3657 secondi in quanto
    $3657$ minimizza la funzione $\frac{x}{\pi} - \left\lfloor\frac{x}{\pi}\right\rfloor$
    meglio di $3600$.
}.
