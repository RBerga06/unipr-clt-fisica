...
Eseguiamo 400 lanci simultanei dei sei dadi, riportando in una tabella il risultato
di ciascuno di essi, ordinati secondo una successione cromatica prestabilita.

\subsection{Simulazione}
Successivamente, simuliamo $10^{12}$ lanci di 5 dadi su un calcolatore tramite un
programma da noi compilato\footnote{\emph{Vedi} Appendice 1}.
Calcolato il valore medio e la deviazione standard del numero di "1" usciti per
ogni lancio dei dadi, riusciremo ad osservare se i lanci da
