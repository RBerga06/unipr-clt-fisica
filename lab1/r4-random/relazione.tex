...
\begin{center}
    \begin{tblr}{ |Q[l,m]|Q[c,m]|Q[c,m]|Q[c,m]| }
        ...
        \hline[dashed]
        Calibro ventesimale & \qty{0.05}{mm} & \qty{150.00}{mm} & \qty{0.01}{mm} \\
        \hline[dashed]
...
\end{aligned}\]
\emph{\textbf{Nota.} Per i calcoli di cui sopra abbiamo
utilizzato i seguenti valori:
\begin{itemize}
    \item $2r = \left(14.00\pm0.05\right)\unit{mm}$ (diametro della finstra del contatore Geiger)
\end{itemize}
}
