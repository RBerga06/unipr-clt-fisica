...
\[p(D\text{ onesto})=p\left(\bigcap_{i=1}^N D_i\text{ onesto}\right)
\ne\prod_{i=1}^{N}p(D_i\text{ onesta})\]
\emph{Si potrebbe definire una funzione a $N$ variabili
$F:\left[0,1\right]^N\longmapsto\left[0,1\right]$, ad esempio:}
...
$p_1,\dots,p_n$ assumano tali valori, in quanto, come detto,
}
