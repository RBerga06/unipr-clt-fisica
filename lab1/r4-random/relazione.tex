...
Allora, detta $\overline{x_\gamma}$ la media teorica\footnote{
...
la distribuzione di probabilità di $x_\gamma$ è data da una Poissoniana:
\[
    p(x_\gamma=k)=\frac{\overline{x_\gamma}^k e^{-\overline{x_\gamma}}}{k!}
    \qquad
    \forall k\in\mathbb{N}
\]
Il valore di $\overline{x_\lambda}$ è legato alla distanza $d_i$ e al tempo
di dimezzamento del $\Th$ ($T_{1/2\;\Th}$)
