...
\]
Il valore di $\overline{x_i}$ è legato alla distanza $d_i$, al tempo
di dimezzamento $T_\frac{1}{2}$ del $\Th$ e alla massa $m$ di $\Th$ secondo la seguente
relazione\footnote{
    ...
    \]
    con $\tau=T_\frac{1}{2}/\ln{2}$ il tempo caratteristico del $\Th$.
