...
il numero di raggi $\gamma$ emessi nell'arco di un secondo nella direzione del contatore
(conteggio) per un tempo complessivo di circa un'ora\footnote{
...
\emph{
    ...
    mentre con $\gamma_{t,i}$ il numero di eventi nell'intervallo temporale
