...
\begin{figure}[H]
    \includegraphics[trim={2cm .5cm 2.4cm 2.1cm},clip,width=.5\textwidth]{img/t1.jpg}
    \includegraphics[trim={2cm .5cm 2.4cm 2.1cm},clip,width=.5\textwidth]{img/t2.jpg}
    \\
    \includegraphics[trim={2cm .5cm 2.4cm 2.1cm},clip,width=.5\textwidth]{img/t3.jpg}
    \includegraphics[trim={2cm .5cm 2.4cm 2.1cm},clip,width=.5\textwidth]{img/t4.jpg}
\end{figure}
\begin{figure}[H]
    \vspace{-.6cm}
    \centering
    \includegraphics[trim={2cm .5cm 2.4cm 2.1cm},clip,width=.5\textwidth]{img/t5.jpg}
