...
\begin{enumerate}
    ...
    \item
        ...
        dalla parte alta, libera di ruotare: grazie al sensore di rotazione, i dati sullo spostamento angolare vengono regstrati, 
        per poi essere graficati in funzione del tempo.
    \item
