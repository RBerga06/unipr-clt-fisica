...
\begin{center}
    \begin{tblr}{ |Q[l,m]|Q[c,m]|Q[c,m]|Q[c,m]| }
        ...
        {Tre cilindri \\ (con masse distinte)} & \SetCell[c=3]{l} {
            ...
            e con $\diam$, $A+B$, $A+C$, $B+C$ e $A+B+C$ \\
...
\begin{enumerate}
    \item
        Misuriamo la massa dei cilindri con la bilancia di precisione e il loro diametro con il calibro ventesimale.
        Usiamo inoltre il metro a nastro e il micrometro ad asta filettata per misurare, rispettivamente, la lunghezza
        e il diametro dei fili.
    \item
        Sistemiamo il filo nel pendolo fissandolo nella parte bassa del sistema in modo tale che la torsione possa avvenire
        dalla parte alta, libera di ruotare: aggiungiamo progressivamente al disco del pendolo i cilindri e le varie combinazioni,
        in modo da ottenere torsioni differenti. Ripetiamo il procedimento per ogni filo.
    \item
