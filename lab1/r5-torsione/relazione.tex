...
Di seguito riportiamo massa, diametro e momento d'inerzia\footnote{
    ...
    Supponendo gli errori su massa e diametro piccoli, casuali e indipendenti,
    abbiamo calcolato $\delta I_i$ secondo la tradizionale propagazione degli errori.
} dei tre cilindretti:
...
al variare dei cilindretti posizionati sopra al filo, si ha:
\[ I_\text{cilindretti} = \frac{C}{4\pi^2}\,T^2 - I_0 \]
Da questa dipendenza lineare, tramite una regressione lineare pesata, è possibile
ottenere una stima piuttosto accurata del valore di $C$.
