...
\begin{tblr}{
  ...
  \hline[dashed]
  Pistone & {
    Mobile, utilizzato per chiudere un'estremità del tubo.
  } \\
  \hline[dashed]
  Generatore di onde & {
...
\begin{enumerate}
  ...
  \item
    Inseriamo il microfono dentro al tubo in modo che riesca a rilevare
...
all'interno di quest'ultimo si forma un'onda di pressione stazionaria.
In tal caso:
\begin{itemize}
...
\begin{enumerate}
  ...
  \item
    ...
    in modo tale che i segnali degli echi siano chiaramente distinguibili.
