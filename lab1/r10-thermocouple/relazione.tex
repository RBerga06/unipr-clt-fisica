...
\begin{figure}[H]
  % <v>^
  \includegraphics[trim={1cm 0.6cm 1cm 1cm},clip,width=.49\textwidth]{img/acqua-fus.png}
  \includegraphics[trim={1cm 0.6cm 1cm 1cm},clip,width=.49\textwidth]{img/azoto.png}
  \includegraphics[trim={1cm 0.6cm 1cm 1cm},clip,width=.49\textwidth]{img/acqua-eb.png}
  \includegraphics[trim={1cm 0.6cm 1cm 1cm},clip,width=.49\textwidth]{img/etanolo.png}
