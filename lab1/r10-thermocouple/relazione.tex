...
\begin{center}
    ...
    \begin{tblr}{
        ...
        \hline[dashed]
        Guanto da forno, pinzette,
        presine e contenitori isolanti & { 
            Per maneggiare oggetti 
            con temperature elevate
            o molto basse.
        } \\
        \hline[dashed]
        Cacciavite & {
        Utilizzato per aprire/chiudere
        il crogiolo contenente l'indio.
        } \\
        \hline[dashed]
        Amplificatore & {
        Amplifica di un fattore 100
        il voltaggio rilevato dalla
        termocoppia.
        } \\
        \hline
    \end{tblr}
