    ...
    \begin{enumerate}
        ...
        \item
            ...
            sufficientemente piccolo\footnote{
                % TODO: specificare la condizione del modello: sin(x) ~ x
            },
...
% TODO: Finire la tabella che segue e metterla in appendice
Di seguito riportiamo distanza e momento d'inerzia per ogni pesetto e
per ogni configurazione:

\begin{center}
\begin{tblr}{ |c|c|c|c|c| }
    \hline
    $i$ & $d_1\;\;(\unit{cm})$ & $d_2\;\;(\unit{cm})$ & $d_3\;\;(\unit{cm})$ & \\
        & $I_1\;\;(\unit{kg\,m^2})$ & $I_2\;\;(\unit{kg\,m^2})$ & $I_3\;\;(\unit{kg\,m^2})$ &  $I_\text{tot}$ \\
    \hline
    $0$ & $12.7\pm0.1$ & & & \\
        & $ ?  \pm ? $ & & & $?$ \\
    \hline[dashed]
    $1,3:1$ & $35.6\pm0.1$ & & $25.0\pm0.1$ & \\
        & $ ?  \pm ? $ & & $?\pm?$ & $?$ \\
    \hline
\end{tblr}
\end{center}
...
Di seguito riportiamo massa, diametro e momento d'inerzia\footnote{
    Il momento d'inerzia è stato calcolato
...
\begin{tblr}{ |c|c|c|c| }
    ...
    % \hline[dashed]
    % 0 & $134.92 \pm 0.01$ & $9.845 \pm 0.005$ & $1.6346\pm0.0018$ \\
    \hline
\end{tblr}
\end{center}
